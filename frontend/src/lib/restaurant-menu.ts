...
export const restaurantMenu: MenuTab[] = [
        ...
        sections: [
          {
            title: null,
            items: [
              { name: "Сырне с розочками", price: 20500 },
              { name: "Тесто для сырне", price: 1000 },
              { name: "Плюшки", price: 170 },
              { name: "Жети нан", price: 1500 },
              { name: "Варка мяса 1 казан", price: 5000 },
              { name: "Контейнер", price: 250 },
              { name: "Залог за посуду", price: 5000 },
            ],
          },
        ],
      },
        ...
        sections: [
          {
            title: null,
            items: [
              { name: "Борщ 1 порция", price: 1400 },
              { name: "Лапша по домашнему", price: 1200 },
              { name: "Котлета 1шт.", price: 750 },
              { name: "Пюре картоф. 1 пор.", price: 500 },
              { name: "Плов с мясом 1 блюдо", price: 14000 },
              { name: "Плов без мяса 1 блюдо", price: 3500 },
              { name: "Манты 1шт.", price: 350 },
              { name: 'Салат "Весна"', price: 2200 },
              { name: 'Салат "Пекинский"', price: 2300 },
              { name: 'Салат "Оливье" (с колбас.)', price: 2000 },
              { name: "Блины 1шт.", price: 150 },
              { name: "Блины фаршир. (творог)", price: 250 },
              { name: "Блины с мясом", price: 300 },
              { name: "Кутья", price: 350 },
              { name: "Булочки, плюшки", price: 170 },
              { name: "Булочки с сухофр.", price: 170 },
              { name: "Лепешки", price: 150 },
              { name: "Лепешки с кунжут. мал.", price: 80 },
              { name: "Баурсаки 1кг.", price: 1500 },
              { name: "Компот 1 графин", price: 900 },
              { name: "Самса 1шт.", price: 300 },
              { name: "Чебуреки 1шт.", price: 300 },
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    subcategories: [
      {
        id: "complex-lunch-items",
        title: "Комплексный обед",
        sections: [
          {
            title: null,
            items: [
              { name: "Бефстроганов", price: 500 },
              { name: "Бризоль компл.", price: 500 },
              { name: "Вареники", price: 350 },
              { name: "Голень с картошкой", price: 500 },
              { name: "Гуляш", price: 500 },
              { name: "Дапанджи с окорочка", price: 0 },
              { name: "Жаркое", price: 600 },
              { name: "Жаркое с мясом", price: 550 },
              { name: "Компот 1 ст", price: 250 },
              { name: "Курица в белом соусе", price: 500 },
              { name: "Курица по тайски", price: 550 },
              { name: "Макароны гарнир", price: 150 },
              { name: "Макароны по флотски", price: 350 },
              { name: "Манты компл.", price: 500 },
              { name: "Мясо по тайски компл", price: 600 },
              { name: "Овощное рагу с мясом", price: 600 },
              { name: "Овощное рагу с окорочком", price: 550 },
              { name: "Орама", price: 500 },
              { name: "Пельмени с бул компл", price: 500 },
              { name: "Пигоди", price: 400 },
              { name: "Плов из гречки", price: 550 },
              { name: "Плов с мясом", price: 900 },
              { name: "Плов с окорочком", price: 500 },
              { name: "Рассольник", price: 1000 },
              { name: "Рис отварной", price: 150 },
              { name: "Рожки по домаш", price: 450 },
              { name: "Салат Азия компл", price: 750 },
              { name: "Салат Аппетитный", price: 650 },
              { name: "Салат Винегрет", price: 700 },
              { name: "Салат Винегрет компл", price: 120 },
              { name: "Салат Витаминный 100гр", price: 500 },
              { name: "Салат Гнездо глухаря", price: 600 },
              { name: "Салат Греческий компл", price: 650 },
              { name: "Салат Капустный по-корейски", price: 600 },
              { name: "Салат Капустный с кукурузой", price: 600 },
              { name: "Салат Капустный с майонезом", price: 600 },
              { name: "Салат Морковный", price: 600 },
              { name: "Салат Морковный с лобой", price: 600 },
              { name: "Салат Морковный с майонезом", price: 600 },
              { name: "Салат морковный с фасолью", price: 600 },
              { name: "Салат Оливье 100гр", price: 700 },
              { name: "Салат Пекинский", price: 650 },
              { name: "Салат с грибами комп", price: 650 },
              { name: "Салат Свежий", price: 650 },
              { name: "Салат Свекольный с майонезом", price: 500 },
              { name: "Салат Сельдь под шубой компл", price: 600 },
              { name: "Салат Французский", price: 650 },
              { name: "Салат Фунчеза", price: 500 },
              { name: "Сливки порц", price: 700 },
              { name: "Спагетти с подливом", price: 400 },
              { name: "Суп гороховый", price: 200 },
              { name: "Суп гречневый", price: 200 },
              { name: "Суп лапша", price: 600 },
              { name: "Суп рисовый", price: 200 },
              { name: "Суп Свекольник", price: 200 },
              { name: "Тефтели", price: 800 },
              { name: "Чашка чая", price: 50 },
              { name: "Чашка чая с лимоном", price: 70 },
              { name: "Чашка чая с молоком", price: 70 },
              { name: "Штрудели", price: 600 },
            ],
          },
        ],
      },
        ...
        sections: [
          {
            ...
            items: [
              ...
              { name: "Чайник чай с молоком бол", price: 800 },
